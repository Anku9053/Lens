...
const About = () => {
  ...
  return (
    <div style={{marginTop:"6rem"}}>
      <div>
        <h1 className="text-white text-center text-7xl font-semibold">About Us</h1>
      </div>
      ...
      >
        <div>
          <div>
            <h1 className='text-white' style={{ fontSize: "2.8rem", fontWeight: "900", margin: "0 0 2rem" }}>Welcome to LENS</h1>
          </div>
          <div>
            <p style={{ fontSize: "1rem", fontWeight: "300", marginTop: "0.2rem", padding: "0.2rem", opacity: "0.8", width: "75%" }} className='text-white'>We put our hearts, souls and sweat into designing and developing custom AI - powered solutions for your business so you don't have to.</p>
          </div>
        ...
        <div style={{ border: "2px solid white", display: "flex", justifyContent: "center", alignItems: "center", width: "100%", backgroundColor: "white", padding: "10px", borderRadius: "10px", transition: "0.3s", transform: hovered ? 'scale(1.1)' : 'none' }}>
