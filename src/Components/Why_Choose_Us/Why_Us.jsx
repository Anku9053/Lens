    ...
    return (
        <div style={{marginTop:"2rem"}}>
            ...
            <div>
                ...
                <p style={{ color: "#8a8a8a", textAlign: "center", fontSize: "20px", lineHeight: "29px", width: "60%", margin: "auto", marginTop: "2rem" }}>Every piece of AI technology shipped from LENS is thoroughly benchmarked via rigorous evaluations. With a global network of experts and academicians, we guarantee the most accurate and robust solutions in the market.</p>
            </div>


            <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)",gap:"1rem", width:"50%", margin:"auto",marginTop:"3rem" }}>
...
<div style={{width:"100%",margin:"auto",background:"transparent",display:"flex",flexDirection:"row",justifyContent:"space-evenly",gap:"1rem",color:"white"}}>

    <div style={{border:"1px solid white",borderRadius:"20px",background:"#1b1c1e",padding:"2rem"}}>
        <h2 style={{fontSize:"1.5rem",fontWeight:"bolder",padding:"1rem",width:"100%"}}>Exclusive Rights</h2>
        <img style={{marginTop:"2rem"}} src="https://lenscorp.ai/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fred.a7efdb29.png&w=128&q=75" alt="Exclusive_rights" />
   ...
   <div style={{border:"1px solid white",borderRadius:"20px",background:"#1b1c1e",padding:"2rem"}}>
                <h2 style={{fontSize:"1.5rem",fontWeight:"bolder",padding:"1rem",width:"100%"}}>Lifetime Support</h2>

        <img style={{marginTop:"2rem"}} src="https://lenscorp.ai/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fblue.f22859fe.png&w=256&q=75" alt="Exclusive_rights" />
        <p style={{marginTop:"1rem",marginRight:"1rem",color:"#828282"}}>
        Our mission is to make an impact in empowering human society with AI. Hence, all Intellectual Property Rights belongs to you.
        </p>
    </div>
   ...
   <div style={{border:"1px solid white",borderRadius:"20px",background:"#1b1c1e",padding:"2rem"}}>
                <h2 style={{fontSize:"1.5rem",fontWeight:"bolder",padding:"1rem",width:"100%"}}>Plug-and-Play</h2>

        <img style={{marginTop:"4rem"}} src="https://lenscorp.ai/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fgreen.e71c8735.png&w=256&q=75" alt="Exclusive_rights" />
   ...
   <div style={{border:"1px solid white",borderRadius:"20px",background:"#1b1c1e",padding:"2rem"}}>
                <h2 style={{fontSize:"1.5rem",fontWeight:"bolder",padding:"1rem",width:"100%"}}>Research Driven</h2>

        <img style={{marginTop:"2rem"}} src="https://lenscorp.ai/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fyellow.d937d179.png&w=256&q=75" alt="Exclusive_rights" />
        <p style={{marginTop:"1rem",marginRight:"1rem",color:"#828282"}}>
        Our mission is to make an impact in empowering human society with AI. Hence, all Intellectual Property Rights belongs to you.
        </p>
    </div>
